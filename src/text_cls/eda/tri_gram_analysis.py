# python src/text_cls/eda/tri_gram_analysis.py -p src/text_cls/dataset/20newsgroups/noun_phrase/train__split_noun_phrase__remove_stopword.csv -i tri_gram_train__split_noun_phrase.png
